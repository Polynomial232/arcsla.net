        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-background text-deep-purple">
                <div className="text-center">
                    ...
                    <h1 className="text-3xl font-black uppercase tracking-tighter mb-4">Talent Lost in the Realm</h1>
                    <p className="text-muted-foreground mb-8">This nobility could not be found in our records.</p>
                    <Link to="/" className="px-8 py-3 bg-accent-yellow text-deep-purple font-bold rounded-full hover:bg-black hover:text-white transition-all">
                        Return to Gates
                    </Link>
                </div>
            </div>
                                ...
                                <div className="relative group">
                                    ...
                                    <div className="absolute -bottom-6 -right-6 bg-white p-4 rounded-2xl shadow-xl border border-accent-purple/10 flex items-center gap-4">
                                        <div className="text-right">
                                            <p className="text-[10px] font-black text-accent-purple uppercase tracking-widest leading-none mb-1">Status</p>
                                            <p className="text-sm font-black text-deep-purple uppercase tracking-tighter leading-none italic">{member.role}</p>
                                        </div>
                        ...
                        <div className="lg:col-span-7">
                            ...
                            >
                                <div className="mb-10">
                                    ...
                                    <p className="text-2xl font-black text-accent-purple/80 uppercase tracking-widest italic">{member.role}</p>
                                </div>
