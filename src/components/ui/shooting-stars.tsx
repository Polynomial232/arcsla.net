...
const getRandomStartPoint = () => {
    ...
    switch (side) {
        ...
        case 2:
            return { x: offset, y: typeof window !== 'undefined' ? window.innerHeight : 1000, angle: 225 };
        case 3:
...
export const ShootingStars: React.FC<ShootingStarsProps> = ({
    ...
    // Unique ID for the linear gradient stop the id collision if multiple stars are on the page
